...
const social = [
    {
        name: 'GitHub',
        icon: 'github', // Define icon in Tailwind if using external icon library
...
const home = {
    ...
    subline: (
        <>
            I'm Selene, a design engineer at <code className="bg-gray-100 px-1 rounded text-sm">FLY</code>, where I
...
const about = {
    ...
    intro: {
        ...
        description: (
            <>
                ...
                elegant design solutions. Her work spans digital interfaces, interactive experiences, and the
    ...
    technical: {
        ...
        skills: [
            {
                title: 'Figma',
                description: <>Able to prototype in Figma with Tailwind CSS with unnatural speed.</>,
                images: [
                    {
            ...
            {
                title: 'Next.js',
                description: <>Building next-gen apps with Next.js + Tailwind CSS + Supabase.</>,
                images: [
                    {
